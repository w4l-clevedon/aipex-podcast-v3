...
class Aipex_Podcast_Admin {
    ...
    public static function tools(){
        ...
        echo '<p><a href="'.esc_url($export_url).'" class="button">⬇ Export: Episodes with SC URL, no Dropbox, no transcript</a> <span style="color:#646970;font-size:13px">Columns: Title, Show, Presenter, SoundCloud URL, Published date</span></p>';
